...
class CNNLSTMWithResNetForActionPrediction(pl.LightningModule):
    def __init__(self, sequence_length=3, lstm_hidden_dim=64, output_dim=11, lstm_layers=2, dropout=0.5):
...
class CNNLSTMWithResNetForActionPrediction(pl.LightningModule):
    def __init__(self, sequence_length=10, lstm_hidden_dim=64, output_dim=11, lstm_layers=2, dropout=0.5):
        super(CNNLSTMWithResNetForActionPrediction, self).__init__()
